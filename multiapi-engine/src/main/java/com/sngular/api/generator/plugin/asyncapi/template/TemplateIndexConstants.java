...
public class TemplateIndexConstants extends CommonTemplateIndexConstants {
  ...
  public static final String TEMPLATE_API_SUPPLIERS_SPRINGWOLF = "templateSuppliersWithSpringwolf.ftlh";

  public static final String TEMPLATE_API_CONSUMERS_SPRINGWOLF = "templateConsumersWithSpringwolf.ftlh";
